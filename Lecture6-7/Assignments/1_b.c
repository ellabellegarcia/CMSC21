...
int main(){
    ...
    A boolean arary that contains true/false values referring to 
    whether a certain pathway is open/close for transportation.

    Only pathways 0 and 3 are open fpr transportation. The rest are close.

    */

    // The remaining elements of the array are given the value of 0 or false
